...
<div class="bd-example-about"id="main-home-style">
    <div class="main-home-about">
      <div class="container" class="text-center">
        <h1 class="main-home-he">Frequently Asked Questions</h1>
        <p><a href="{{ url('/') }}">Homepage /</a> <a href="{{ url('/faqs') }}">FAQ's</a></p>
      </div>
    </div>
   </div>
